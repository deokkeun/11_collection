...
public class StudentService {
	...
	// List<Student> studentList = new LinkedArrayList<Student>(); // 추가, 수정, 삭제 효율적
	...
	public void ex() {
		...
		// 다운 캐스팅을 해야 (get(int index) 메소드가 반환형이 Object이기 때문에)
	...
	public void serchName2() {
		...
		for(Student std : studentList) {
			...
			// contains : 포함
			// boolean String.contaiins(문자열) : String에 문자열에 포함되어있으면 true
