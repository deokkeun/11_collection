...
public class SetService {
	...
	public void ex1() {
		...
		// 다른클래스 만들때는 equals, hashCode가 오버라이딩 해야함.
		...
		// -> 대신에 Set 전체의 데이터를 하나씩 반복적으로 언어올 순 있다.
	...
	public void ex3() {
		...
		memberSet.add(new Member("user01", "pass04", 30));
		memberSet.add(new Member("user02", "pass04", 40));
		memberSet.add(new Member("user03", "pass04", 20));
	...
	public void ex4() {
		...
		System.out.println("int 최대값 : " + Integer.MIN_VALUE); // static
	...
	public void lotto() {
		...
		while(lotto.size() < 6) {
			...
			lotto.add(random); 
			// int 값이 자동으로 Integer로 포장(AutoBoxing)되어 lotto추가
